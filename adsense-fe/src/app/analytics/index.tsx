...
export default function Analytics() {
  ...
  const data = Object.keys(referrerReferralMap).map((referrer, index) => {
    ...
    return {
      ...
      rewards: parseFloat(totalRewards.toFixed(2)),
      totalReferrals,
  ...
  const hardcoreDummyData = [
    { id: 1, referrer: truncateString("0xffwekr45n75wjfbew4ce6ab8827279cffr423266", 25), rewards: 2.3, totalReferrals: 5, campaignAddress: truncateString("0x5fbdb2315678afecb367f032d93f642f64180aa3", 25) },
    { id: 2, referrer: truncateString("0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266", 25), rewards: 1.8, totalReferrals: 3, campaignAddress: truncateString("0x726as3e6qs237tq7238h6ab8827279cfffb92266", 25) },
    { id: 3, referrer: truncateString("0xf76g45rg4go43gb77878hffyb827279cffa92266", 25), rewards: 3.2, totalReferrals: 7, campaignAddress: truncateString("0x7623nqdo7hq47q3qndq78ab8827279cfffb92266", 25) },
    { id: 4, referrer: truncateString("0xf67o32yufhrfbqfgyf7486ab882727cfffb92266", 25), rewards: 0.5, totalReferrals: 2, campaignAddress: truncateString("0x89apae98jdq89qnq9qaddda8827279cfffb92266", 25) },
    { id: 5, referrer: truncateString("0xf76t34qgrad33du9sd0djnf88ljknqcfffb92266", 25), rewards: 2.1, totalReferrals: 4, campaignAddress: truncateString("0x9kdsa8f849q3junndn8q6ab8827279cfffb92266", 25) },
  ];
